...
typedef struct __wt_prepvs_entry WT_PREPVS_ENTRY;
struct __wt_leafvs_file;
typedef struct __wt_leafvs_file WT_LEAFVS_FILE;
struct __wt_leafvs_file_header;
typedef struct __wt_leafvs_file_header WT_LEAFVS_FILE_HEADER;
struct __wt_leafvs_key_group;
typedef struct __wt_leafvs_key_group WT_LEAFVS_KEY_GROUP;
...
typedef struct __wt_leafvs_ver WT_LEAFVS_VER;
union __wt_lsn;
